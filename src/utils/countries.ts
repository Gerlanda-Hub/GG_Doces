...
// List of all countries in the world with their flags and dial codes, sorted alphabetically by Portuguese name.
export const countries: Country[] = [
  ...
  { name: 'Burquina Fasso', code: '+226', flag: '🇧🇫' },
  ...
  { name: 'Ilha de Man', code: '+44-1624', flag: '🇮🇲' },
  { name: 'Ilha Norfolk', code: '+672', flag: '🇳🇫' },
  { name: 'Ilhas Caimão', code: '+1-345', flag: '🇰🇾' },
  { name: 'Ilhas Cocos (Keeling)', code: '+61', flag: '🇨🇨' },
  { name: 'Ilhas Cook', code: '+682', flag: '🇨🇰' },
  { name: 'Ilhas Malvinas', code: '+500', flag: '🇫🇰' },
  { name: 'Ilhas Faroé', code: '+298', flag: '🇫🇴' },
  { name: 'Ilhas Marianas do Norte', code: '+1-670', flag: '🇲🇵' },
  { name: 'Ilhas Marshall', code: '+692', flag: '🇲🇭' },
  { name: 'Ilhas Salomão', code: '+677', flag: '🇸🇧' },
  { name: 'Ilhas Turcas e Caicos', code: '+1-649', flag: '🇹🇨' },
  { name: 'Ilhas Virgens Britânicas', code: '+1-284', flag: '🇻🇬' },
  { name: 'Ilhas Virgens Americanas', code: '+1-340', flag: '🇻🇮' },
  ...
  { name: 'Macedónia do Norte', code: '+389', flag: '🇲🇰' },
  { name: 'Madagáscar', code: '+261', flag: '🇲🇬' },
  ...
  { name: 'Nova Caledónia', code: '+687', flag: '🇳🇨' },
  ...
  { name: 'São Martinho (Países Baixos)', code: '+1-721', flag: '🇸🇽' },
...
// Helper to parse a full phone number into a Country Code and raw phone number
export function parsePhoneNumber(fullPhone: string): { dialCode: string; localNumber: string } {
  ...
  if (!cleaned.startsWith('+')) {
    return { dialCode: '+244', localNumber: cleaned }; // Default to Angola
  }

  // Find matching dial code (longest match first to avoid +1 vs +1-264 conflicts)
